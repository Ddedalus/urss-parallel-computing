...
res <- runSizes(algoDistances, graphGenerator, sizes, 50, inputArgs = c(distrSampler = sampler), algArgs = c())
...
pred <- predict(squarefit, newdata = total)
{ plot(total$nodes, total$elapsed, col="red")
  points(total$nodes, pred, col="green")}
```
